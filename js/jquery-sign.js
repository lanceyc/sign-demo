    ...
    */
    ...
    function defined(dom) {
        ...
        $(document).on("click", "#addsign", function (e) {
            ...
            //$('.inputSignBox').append("<div class='signbox' contenteditable='true' id='inputText' tabindex='-1'> < em id = 'deflutText' > 输入第三方标记</em > </div > ");
            $('.inputSignBox').append("<div class='signbox'  id='inputText' tabindex='-1'> T <input type='radio' name='flag' value='T'/><br/>  X <input type='radio' name='flag' value='X'/><br/>= <input type='radio' name='flag' value='='/></div > ");
            $('.inputSignBox').append("<div class='sureSign' onclick='confirm_click()'>确定</div>");
        ...
        $(document).on('click', '.sureSign', function () {
            ...
            if ($('.signbox em').length > 0) {
                ...
                var text = $("input[name='flag']:checked").val();
